...
<body>
    ...
    <main>
        <div
            ...
            <h1 class="course-header">Overview of Presentasi</h1>
                    ...
                    <ul class="course-menu-list">
                        <li class="course-menu-item active">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 1. Desain Slide Efektif
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 2. Penggunaan Gambar & Grafik
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 3. Multimedia & Audio
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 4. Alat & Setup Presentasi
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 5. Interaktivitas & Q&A
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                    </ul>
    ...
    <script>
        const materials = [
            {
                title: "1. Desain Slide Efektif",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Prinsip desain slide: lebih sedikit teks, kontras yang jelas, dan fokus pada pesan utama setiap slide."
            },
            {
                title: "2. Penggunaan Gambar & Grafik",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Memilih gambar yang relevan dan membuat grafik yang menjelaskan data dengan cepat dan jelas."
            },
            {
                title: "3. Multimedia & Audio",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Mengintegrasikan video dan audio secara efektif tanpa mengganggu alur presentasi."
            },
            {
                title: "4. Alat & Setup Presentasi",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Checklist peralatan, konektivitas, dan pengaturan ruangan untuk menghindari masalah teknis."
            },
            {
                title: "5. Interaktivitas & Q&A",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Metode membuat sesi interaktif dan menangani pertanyaan audiens dengan percaya diri."
            },
        ];
        ...
        const MATERIAL_ID = 'media_presentasi';
        ...
        nextBtn.addEventListener('click', () => {
            if (currentIndex < materials.length - 1) {
                ...
                alert("Selamat! Anda telah menyelesaikan kelas Media Presentasi.");
