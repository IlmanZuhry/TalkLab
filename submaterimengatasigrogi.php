...
<body>
    ...
    <main>
        <div
            ...
            <h1 class="course-header">Overview of Mengatasi Grogi</h1>

            <div class="course-container">
                <!-- Sidebar Menu -->
                <div class="course-sidebar">
                    <div class="course-sidebar-header">
                        <span>Materi Mengatasi Grogi</span>
                    </div>
                    <ul class="course-menu-list">
                        <li class="course-menu-item active">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 1. Persiapan Mental
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 2. Teknik Pernapasan untuk Grogi
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 3. Visualisasi & Persiapan
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 4. Latihan Paparan Bertahap
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 5. Strategi Saat On-Stage
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                    </ul>
    ...
    <script>
        const materials = [
            {
                title: "1. Persiapan Mental",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Teknik mindset untuk mengurangi kecemasan sebelum tampil: penetapan tujuan, afirmasi, dan rutinitas pra-panggung."
            },
            {
                title: "2. Teknik Pernapasan untuk Grogi",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Latihan pernapasan singkat untuk menurunkan detak jantung dan menstabilkan suara saat grogi."
            },
            {
                title: "3. Visualisasi & Persiapan",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Menggunakan visualisasi untuk membayangkan situasi sukses dan mengurangi ketakutan performa."
            },
            {
                title: "4. Latihan Paparan Bertahap",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Strategi membiasakan diri tampil di depan kecil ke besar untuk mengurangi grogi secara bertahap."
            },
            {
                title: "5. Strategi Saat On-Stage",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Tips praktis di atas panggung: anchor, fokus titik, dan teknik grounding untuk tetap tenang."
            },
        ];
        ...
        const MATERIAL_ID = 'mengatasi_grogi';
        ...
        nextBtn.addEventListener('click', () => {
            if (currentIndex < materials.length - 1) {
                ...
                alert("Selamat! Anda telah menyelesaikan kelas Mengatasi Grogi.");
