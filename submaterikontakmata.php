...
<body>
    ...
    <main>
        <div
            ...
            <h1 class="course-header">Overview of Kontak Mata</h1>

            <div class="course-container">
                <!-- Sidebar Menu -->
                <div class="course-sidebar">
                    <div class="course-sidebar-header">
                        <span>Materi Kontak mata</span>
                    </div>
                    <ul class="course-menu-list">
                        <li class="course-menu-item active">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 1. Teknik Eye Contact Dasar
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 2. Zona Audiens & Fokus
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 3. Timing & Durasi Tatap Mata
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 4. Mengatasi Malu & Ragu
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                        <li class="course-menu-item">
                            <div class="course-menu-icon">
                                <span class="icon-text">▶</span> 5. Latihan Praktis Kontak Mata
                            </div>
                            <span class="course-check-icon">✓</span>
                        </li>
                    </ul>
    ...
    <script>
        const materials = [
            {
                title: "1. Teknik Eye Contact Dasar",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Prinsip dasar kontak mata: bagaimana membangun koneksi tanpa terasa mengintimidasi."
            },
            {
                title: "2. Zona Audiens & Fokus",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Membagi audiens ke zona dan teknik memindahkan fokus agar semua merasa terlibat."
            },
            {
                title: "3. Timing & Durasi Tatap Mata",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Berapa lama ideal menatap satu titik, dan bagaimana mengatur tempo tatapan secara alami."
            },
            {
                title: "4. Mengatasi Malu & Ragu",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Latihan mental singkat untuk mengurangi rasa malu saat bertatap muka dengan audiens."
            },
            {
                title: "5. Latihan Praktis Kontak Mata",
                videoSrc: "https://www.w3schools.com/html/mov_bbb.mp4",
                script: "Serangkaian latihan sederhana untuk melatih kontak mata dalam berbagai situasi presentasi."
            },
        ];
        ...
        nextBtn.addEventListener('click', () => {
            if (currentIndex < materials.length - 1) {
                ...
                alert("Selamat! Anda telah menyelesaikan kelas Kontak Mata.");
